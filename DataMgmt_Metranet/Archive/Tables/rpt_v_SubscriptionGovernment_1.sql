CREATE TABLE [Archive].[rpt_v_SubscriptionGovernment] (
...
GO
CREATE CLUSTERED INDEX [cx_rpt_v_subscriptiongovernment]
    ON [Archive].[rpt_v_SubscriptionGovernment]([ArchiveID] ASC);
