CREATE TABLE [dbo].[rpt_v_SubscriptionSelectAccess] (
    [id_sub]                     INT              NULL,
    [id_po]                      INT              NULL,
    [id_acc]                     INT              NULL,
...
GO
CREATE CLUSTERED INDEX [rpt_v_SubscriptionSelectAccess_pk]
    ON [dbo].[rpt_v_SubscriptionSelectAccess]([id_sub] ASC, [id_pi_instance] ASC, [id_sched] ASC, [n_order] ASC);


GO
CREATE NONCLUSTERED INDEX [idx_rpt_v_SubscriptionSelectAccess_id_sub]
    ON [dbo].[rpt_v_SubscriptionSelectAccess]([id_sub] ASC)
    INCLUDE([vt_start], [vt_end]);


GO
CREATE NONCLUSTERED INDEX [idx_rpt_v_SubscriptionSelectAccess_id_sub_includes6]
    ON [dbo].[rpt_v_SubscriptionSelectAccess]([id_sub] ASC)
