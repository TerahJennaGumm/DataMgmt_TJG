...
CREATE view [CONCUR\MinalC].[vw_SAMEWEBSITE_SAMEOWNER_SMB_NoSAPData] as (
select 
...
, d.name [DandbCompany Primary Business Name] --DandbCompany Primary Business Name
...
where Website in 
(
select Website from DataMgmt_SFDC.dbo.Account with (nolock)
where 
