...
CREATE view  [CONCUR\MinalC].[vw_Outtask_Account_MatchAll_And_SAs_join]
as (
...
full outer join dm_cons.[dbo].[vw_Outtask_Account_MatchAll_MetranetActiveCust_Oppo] a
on s.company_id = a.company_id
left join metranet_data.dbo.rpt_v_account m
