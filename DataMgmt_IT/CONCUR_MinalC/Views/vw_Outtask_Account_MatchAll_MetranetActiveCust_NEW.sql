...
CREATE view [CONCUR\MinalC].[vw_Outtask_Account_MatchAll_MetranetActiveCust_NEW] as 
with cte (cteloginid)
as
(
select business_login from [$(DataMgmt_Metranet)].dbo.vw_MN_CustAccount
union
select secondary_biz_login from [$(DataMgmt_Metranet)].dbo.vw_MN_CustAccount where secondary_biz_login LIKE '001%'
)
