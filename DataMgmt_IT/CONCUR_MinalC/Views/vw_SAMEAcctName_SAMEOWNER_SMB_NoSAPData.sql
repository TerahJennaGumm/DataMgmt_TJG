...
CREATE view [CONCUR\MinalC].[vw_SAMEAcctName_SAMEOWNER_SMB_NoSAPData] as (
select 
...
, aa.OwnerId, uu.Name, uu.Owner_Record_Business_Unit__c, Owner_Record_Market__c --Owner Full Name
...
where aa.Name in 
(
select Name from DataMgmt_SFDC.dbo.Account with (nolock)
where 
