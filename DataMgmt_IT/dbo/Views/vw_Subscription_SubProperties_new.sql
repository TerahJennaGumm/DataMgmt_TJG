...
CREATE VIEW [dbo].[vw_Subscription_SubProperties_new] AS
...
FROM [$(DataMgmt_Metranet)].dbo.t_char_values GROUP BY (id_entity)
)
...
FROM [$(DataMgmt_Metranet)].dbo.rpt_v_Subscription rv JOIN cte ON cte.id_entity = rv.id_sub
UNION
SELECT cte.BISETriggerDate, cte.CancelSubscription, cte.ConcurOrderID, cte.TimeAndMaterials, cte.S4ProviderContractID,cte.DateCreate, id_sub, id_po, id_acc, vt_start, vt_end, id_pi_instance, id_sched, c_ICBRateCustCurr, c_ICBRateUSD, dt_start, dt_end, ConcurOrderLineID, rv.CancelSubscription AS 'rpt_CancelSubscription'
FROM [$(DataMgmt_Metranet)].dbo.rpt_v_SubscriptionGovernment rv JOIN cte ON cte.id_entity = rv.id_sub
UNION
SELECT cte.BISETriggerDate, cte.CancelSubscription, cte.ConcurOrderID, cte.TimeAndMaterials, cte.S4ProviderContractID,cte.DateCreate, id_sub, id_po, id_acc, vt_start, vt_end, id_pi_instance, id_sched, c_ICBRateCustCurr, c_ICBRateUSD, dt_start, dt_end, ConcurOrderLineID, rv.CancelSubscription AS 'rpt_CancelSubscription'
FROM [$(DataMgmt_Metranet)].dbo.rpt_v_SubscriptionSelectAccess rv JOIN cte ON cte.id_entity = rv.id_sub
UNION
SELECT cte.BISETriggerDate, cte.CancelSubscription, cte.ConcurOrderID, cte.TimeAndMaterials, cte.S4ProviderContractID,cte.DateCreate, id_sub, id_po, id_acc, vt_start, vt_end, id_pi_instance, id_sched, c_ICBRateCustCurr, c_ICBRateUSD, dt_start, dt_end, ConcurOrderLineID, rv.CancelSubscription AS 'rpt_CancelSubscription'
FROM [$(DataMgmt_Metranet)].dbo.rpt_v_Subscription_Compleat_GDSX rv JOIN cte ON cte.id_entity = rv.id_sub
