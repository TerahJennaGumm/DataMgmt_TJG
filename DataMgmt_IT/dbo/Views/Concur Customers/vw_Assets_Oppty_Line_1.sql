create view [dbo].[vw_Assets_Oppty_Line] as
SELECT 
...
left outer join [$(DataMgmt_SFDC)].dbo.OpportunityLineItem li ON (LEFt(f.nm_value,18) = li.OpportunityId AND li.MN_PO_ID__c = a.id_po and li.MN_PI_ID__c = ass.MN_PI_ID__c)
