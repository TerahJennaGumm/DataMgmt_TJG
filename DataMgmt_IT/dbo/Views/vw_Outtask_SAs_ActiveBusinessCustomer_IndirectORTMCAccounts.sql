...
JOIN DataMgmt_IT.[dbo].[vw_MN_CustAccount] c ON (c_CBSFAID = c.secondary_biz_login OR c_CBSFAID = c.business_login )
RIGHT JOIN [DataMgmt_IT].dbo.Outtask_Company_List_SA ocls ON (ac.nm_login = ocls.CONTRACT_EXTERNAL_REFERENCE_ID)
WHERE 
