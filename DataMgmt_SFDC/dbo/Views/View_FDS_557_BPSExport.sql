...
create VIEW [dbo].View_FDS_557_BPSExport AS 
(
SELECT
...
FROM [DataMgmt_IT].[dbo].[Account_0809] a
...
--   ,* INTO DataMgmt_SFDC.dbo.RowNumber_FDS_557_BPSExport
--FROM  DataMgmt_SFDC.dbo.FDS_557_BPSExport
